...
if PRODUCTION_ENVRIONMENT:
    ...
    update_start = datetime.datetime.strptime("2017-05-08",'%Y-%m-%d')
...
##### Daily Balance data
def update_daily_balance_master_file(file_total_deposit,file_total_deposit_client,date_mapping,balance_type,update_start=update_start):
