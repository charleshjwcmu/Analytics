...
#                print(data_color.iloc[k[0]-1,k[1]-1])
                ...
                elif determine_color=="grey":
                    cell.set_facecolor('#EAEAEA')
                elif determine_color=="lightgreen":
                    cell.set_facecolor('#AABC00')
                elif determine_color=="green":
                    cell.set_facecolor('#287D14')
...
def rename_legalentity(data_all):
...
def rename_behaviorgroup(data_all):
...
def rename_investmentstyle(data_all):
...
#    data_all = table_tmp
    ...
    data_all = rename_legalentity(data_all)
    
    #rename product types
    data_all = rename_producttypes(data_all)
        
    # behavior group
    data_all = rename_behaviorgroup(data_all)
    
    # region
    data_all = rename_region(data_all)
    
    # Currency
    data_all = rename_currency(data_all)
    
    # country of domicile
    data_all = rename_domicile(data_all)
    
    # investment style
    data_all = rename_investmentstyle(data_all)
    return(data_all)